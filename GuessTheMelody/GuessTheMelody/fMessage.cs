...
namespace GuessTheMelody
{
    public partial class fMessage : Form
    {
        ...
        private void timer1_Tick(object sender, EventArgs e)
        {
            ...
            {
                timer1.Stop();
                SoundPlayer sp = new SoundPlayer("Resources\\REM.wav");
                sp.Play();
                }            
        }
        ...
        {
            //TagLib.File = var
            //TagLib.File mp3files = TagLib.File.Create(Victorina.answer);
            //lbShowAnswer.Text = mp3files.Tag.FirstAlbumArtist + " " + mp3files.Tag.Title;
            lbShowAnswer.Text = Victorina.answer.ToString();
